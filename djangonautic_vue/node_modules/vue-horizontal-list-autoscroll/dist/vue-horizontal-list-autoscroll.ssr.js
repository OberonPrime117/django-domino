...
var smoothscroll_1 = smoothscroll.polyfill;smoothscroll.polyfill();
var script = {
  ...
  watch: {
    "options.slideshow.enabled": function optionsSlideshowEnabled(val) {
      if (!val) {
        this.stopSlideshow();
      } else {
        this.stopAutoscroll();
    ...
    _options: function _options() {
      ...
      return {
        ...
        autoscroll: {
          ...
          interval: options && options.autoscroll && parseInt(options.autoscroll.interval, 10) >= 1 && parseInt(options.autoscroll.interval, 10) || 5000,
          repeat: options && options.autoscroll && options.autoscroll.repeat || false
        },
        item: {
        ...
        slideshow: {
          enabled: options && options.slideshow && options.slideshow.enabled || false,
          interval: options && options.slideshow && options.slideshow.interval || 5000,
          repeat: options && options.slideshow && options.slideshow.repeat || false
        }
      };
    },
  ...
  methods: {
    ...
    autoscroll: function autoscroll() {
      ...
      this.autoscrollInterval = setInterval(function () {
        if (_this2._hasNext) {
          ...
          if (_this2._options.autoscroll.repeat) {
            _this2.position = 0;

            _this2.go(_this2.position);
          }
        }
     ...
     */
    runSlideshow: function runSlideshow() {
      var _this3 = this;

      this.slideshowInterval = setInterval(function () {
        if (_this3._options.slideshow.repeat && _this3.position === _this3._length - _this3._size) {
          _this3.position = 0;

          _this3.go(_this3.position);
        } else {
          _this3.position += 1;
...
var __vue_render__ = function __vue_render__() {
  ...
  }, [_vm.width.window > _vm._options.navigation.start ? _vm._ssrNode("<div class=\"vhl-navigation\" data-v-811c8004>", "</div>", [_vm._hasPrev ? _vm._ssrNode("<div class=\"vhl-btn-left\" data-v-811c8004>", "</div>", [_vm._t("nav-prev", [_c('svg', {
    attrs: {
  ...
  })])])], 2) : _vm._e(), _vm._ssrNode(" "), _vm._hasNext ? _vm._ssrNode("<div class=\"vhl-btn-right\" data-v-811c8004>", "</div>", [_vm._t("nav-next", [_c('svg', {
    attrs: {
      "fill": _vm._options.navigation.color,
      "width": "32px",
      "height": "32px",
  ...
  })])])], 2) : _vm._e()], 2) : _vm._e(), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"vhl-container\"" + _vm._ssrStyle(null, _vm._style.container, null) + " data-v-811c8004>", "</div>", [_vm._ssrNode("<div" + _vm._ssrClass("vhl-list", _vm._options.list.class) + _vm._ssrStyle(null, _vm._style.list, null) + " data-v-811c8004>", "</div>", [_vm._l(_vm.items, function (item, index) {
    return _vm._ssrNode("<div" + _vm._ssrClass("vhl-item", _vm._options.item.class) + _vm._ssrStyle(null, _vm._style.item, null) + " data-v-811c8004>", "</div>", [_vm._t("default", [_vm._v(_vm._s(item))], {
      "item": item
    })], 2);
  }), _vm._ssrNode(" <div" + _vm._ssrStyle(null, _vm._style.tail, null) + " data-v-811c8004></div>")], 2)])], 2);
};
...
var __vue_scope_id__ = "data-v-811c8004";
/* module identifier */

var __vue_module_identifier__ = "data-v-811c8004";
/* functional template */
...
var install = function install(Vue) {
  ...
  Vue.component('VueHorizontalListAutoscroll', __vue_component__);
